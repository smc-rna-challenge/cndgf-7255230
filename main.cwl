...
doc: 'SMC-RNA challenge fusion detection submission
  ...
  inputs section: index, fastq, fqstq2, csindex, and fusionout eg. json: ''index'':
  {''class'': ''Directory'',''path'': ''star_index''}, ''TUMOR_FASTQ_1'': {''class'':
  ''File'',''path'': ''sim1_mergeSort_1.fq.gz''}, ''TUMOR_FASTQ_2'': {''class'': ''File'',''path'':
  ''sim1_mergeSort_2.fq.gz''}, ''csindex'': {''class'': ''Directory'',''path'': ''bowtie1_index''}
...
- id: result
  ...
  - {default: final.bedpe, id: fusionout}
