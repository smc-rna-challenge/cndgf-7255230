SMC-RNA Challenge Entry: cndgf-7255230
========================================================
...
```bash
# Clone this repo
git clone https://github.com/smc-rna-challenge/cndgf-7255230
cd cndgf-7255230
...
- [quay.io/smc-rna-challenge/cndgf-7255230-star:1.0.0](https://quay.io/smc-rna-challenge/cndgf-7255230-star:1.0.0)

- [quay.io/smc-rna-challenge/cndgf-7255230-cn_chimerascan:1.0.0](https://quay.io/smc-rna-challenge/cndgf-7255230-cn_chimerascan:1.0.0)
...
Adaptor sequences remaining in the reads, Poor quality 3’ ends of reads, Duplicate reads, The presence of few reads spanning splice junctions, The presence of many multiply-mapped reads -- i.e. those reads having more than one match in the reference
...
[data]: https://www.synapse.org/#!Synapse:syn9878843
